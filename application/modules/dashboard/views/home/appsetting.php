        ...
        <div class="col-sm-12 col-md-12">
            ...
            <tr><td> <img src="<?php echo base_url('assets/img/qr/'.$qr) ?>" class="img-responsive center-block appsettingqr" alt="">
                ...
                <div class="col-sm-6 playstorelink">
                     <a href="https://play.google.com/store/apps/details?id=com.situscomhrm" target="blank"><h2>Download Mobile Apps From  
                 Playstor</h2></a>
                <h1 class="text-center playstorelinktext"><a href="https://play.google.com/store/apps/details?id=com.situscomhrm" target="blank" class="text-center"><i class="fa fa-android"></i></a></h1>
                </div>
            </div>
  <hr>
        ...
        <div class="row text-center">
           <h2>To enable Mobile apps addons for your business please contact at : </h2><span class="contact-addons">business@situscom.com</span> , Skype : <span class="contact-addons">situscom</span>
        </div>
            </div>
        </div>
    </div>
