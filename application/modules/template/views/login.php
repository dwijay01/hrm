            ...
            <div class="panel panel-bd">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="<?php echo display('email') ?>" name="email"
                            value="<?php echo @$user->email; ?>" id="email" class="form-control">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="<?php echo display('password') ?>" name="password"
                            value="<?php echo @$user->password; ?>" id="password" class="form-control">
                    </div>
