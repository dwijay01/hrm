...
//Get MIN_VERSION
define('MIN_VERSION', file_get_contents('https://update.situscom.com/hrm/autoupdate/update_min_version'));
//Get MAX_VERSION
define('MAX_VERSION', file_get_contents('https://update.situscom.com/hrm/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.situscom.com/hrm/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.situscom.com/hrm/autoupdate/update_info');
define('VERSION_PATH','https://update.situscom.com/hrm/versions/');
